...
@click.option(
    "--subplots", "-b", is_flag=True, help="Make subplots from multiple datasets."
)
@click.option(
    "--nsubplotrow",
    "num_subplot_row",
...
@click.option(
    "--cnlevels", type=click.INT, help="Specify the number of levels for contours"
)
...
@click.option(
    "--sdensity", type=click.INT, default=1, help="Control density of the streamlines."
)
@click.option(
    "--arrowstyle", type=click.STRING, help="Set the style for streamline arrows."
)
@click.option(
    "--lineouts", type=click.Choice(["0", "1"]), help="Switch to lineouts mode."
)
@click.option("-s", "--scatter", is_flag=True, help="Make scatter plot.")
@click.option(
    "--markersize", type=click.FLOAT, help="Set marker size for scatter plots."
)
@click.option("--linewidth", type=click.FLOAT, help="Set the linewidth.")
@click.option(
    "--linestyle",
    type=click.Choice(["solid", "dashed", "dotted", "dashdot"]),
...
@click.option(
    "--relax", is_flag=True, help="Relax the stringent x axis limits for 1D plots."
)
@click.option(
    "--globalrange", "-r", is_flag=True, help="Make uniform extends across datasets."
)
...
@click.option(
    "--showgrid/--no-showgrid", default=True, help="Show grid-lines (default: True)"
)
...
@click.option(
    "--jet", is_flag=True, help="Turn colormap to jet for comparison with literature."
)
@click.option(
    "--cmap",
    type=click.STRING,
