...
@click.command()
@click.option(
    "--z0", default=None, help="Indices for 0th coord (either int, float, or slice)"
)
@click.option(
    "--z1", default=None, help="Indices for 1st coord (either int, float, or slice)"
)
@click.option(
    "--z2", default=None, help="Indices for 2nd coord (either int, float, or slice)"
)
@click.option(
    "--z3", default=None, help="Indices for 3rd coord (either int, float, or slice)"
)
@click.option(
    "--z4", default=None, help="Indices for 4th coord (either int, float, or slice)"
)
@click.option(
    "--z5", default=None, help="Indices for 5th coord (either int, float, or slice)"
)
@click.option(
    "--comp",
    "-c",
...
def select(ctx, **kwargs):
  ...
  for dat in data.iterator(kwargs["use"]):
    if kwargs["tag"]:
      ...
      grid, values = postgkyl.data.select(
          dat,
          z0=kwargs["z0"],
          z1=kwargs["z1"],
          z2=kwargs["z2"],
