...
@click.option("--no-contour", default=False, is_flag=True, help="Enables full volume rendering (expensive).")
...
@click.option("--mesh-clip-plane", default=False, is_flag=True, help="2D plane widget that clips contoured data to make it disappear.")
@click.option("--mesh-slice-plane", default=False, is_flag=True, help="2D slice widget on a 3D mesh. Best used with --no-contour.")
@click.option("--volume-clip-plane", default=False, is_flag=True, help="2D plane widget that clips volume data to make it disappear.")
