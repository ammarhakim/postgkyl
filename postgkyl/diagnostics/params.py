...
def get_vA(species_data=None, species_grid=None, species_values=None,
           field_data=None, field_grid=None, field_values=None,
           mass=1.0, mu0=1.0):
...
def get_omegaP(species_data=None, species_grid=None, species_values=None,
               field_data=None, field_grid=None, field_values=None,
               mass=1.0, charge=1.0, epsilon0=1.0):
  # Fluid data already has mass factor in density
  out_grid, rho = diag.get_density(species_data, species_grid, species_values)
...
def get_d(species_data=None, species_grid=None, species_values=None,
          field_data=None, field_grid=None, field_values=None,
